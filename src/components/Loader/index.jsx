...
function Loader() {
  return (
    <div className={styles.loading}>
      <div class={styles.preloader} style={{ opacity: 1 }}>
        <svg
          version="1.1"
          id={styles.sun}
        ...
        <div class={styles.rain}>
          <span class={styles.drop}></span>
          <span class={styles.drop}></span>
          <span class={styles.drop}></span>
          <span class={styles.drop}></span>
          <span class={styles.drop}></span>
        ...
        <div class={styles.text}>GETTING THE WEATHER FORECAST FOR YOU...</div>
      </div>
    </div>
  );
}
